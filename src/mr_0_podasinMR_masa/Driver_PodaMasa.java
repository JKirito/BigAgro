...
//		System.setProperty("producto", "soja");
		...
		FileInputFormat.setInputPaths(job, new Path(
				"/media/pruebahadoop/06668E5C668E4C7D/Ubuntu_Share/javi/Documentos/Monitores rendimiento hackatón agro-datos 2014/CSV/input/serie-0.csv"), new Path("/media/pruebahadoop/06668E5C668E4C7D/Ubuntu_Share/javi/Documentos/Monitores rendimiento hackatón agro-datos 2014/CSV/tmp/monitoresLivianoNewFormat.csv"));
		FileOutputFormat.setOutputPath(job, new Path("/media/pruebahadoop/06668E5C668E4C7D/Ubuntu_Share/javi/Documentos/Monitores rendimiento hackatón agro-datos 2014/CSV/outputs/poster/PODA_sortSinMR/"));
