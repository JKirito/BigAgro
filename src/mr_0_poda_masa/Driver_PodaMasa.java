...
//		System.setProperty("producto", "soja");
		...
		job.setPartitionerClass(ProductoCampañaPartitioner.class);
		job.setGroupingComparatorClass(ProductoCampaña_GroupComparator.class);

		job.setMapOutputKeyClass(MasaProductoCampañaWritable.class);
