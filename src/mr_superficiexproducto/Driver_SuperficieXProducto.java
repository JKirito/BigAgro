...
public class Driver_SuperficieXProducto {
...
//		System.setProperty("filtrar", "N");//S(SI)/N(NO)
		...
		job.setJarByClass(Driver_SuperficieXProducto.class);
		// TODO: specify a mapper
		job.setMapperClass(Mapper_superficiexproducto.class);
		// TODO: specify a reducer
		job.setReducerClass(Reducer_superficiexproducto.class);
		...
		FileOutputFormat.setOutputPath(job, new Path("/media/pruebahadoop/a0eb64d8-ab5e-41a9-8f15-1a9079769f72/javi/Documentos/Monitores rendimiento hackatón agro-datos 2014/CSV/outputs/superficieXproducto"));
